            ...
            <tbody>
              {filtered.map((a) => (
                ...
                >
                  ...
                  <td style={{ padding: "10px 16px", color: S.black70 }}>{a.type}</td>
                  <td style={{ padding: "10px 16px", color: S.black70 }}>
                    {getLocation(a.location)}
                  </td>
                  <td style={{ padding: "10px 16px" }}>
                    <StatusBadge status={a.status} />
                  </td>
                  <td style={{ padding: "10px 16px", color: S.black70 }}>{a.readyDate}</td>
                  <td style={{ padding: "10px 16px", fontWeight: 600, color: S.black90 }}>
